...
public class Introducir { //esta clase va a contener métodos para leer variables desde teclado
    ...
    //Método estático calculo (Solo es para el examen de la 1ª Evaluación)
    //Datos de entrada: tipo -entero-, precio -real doble-
    //Salida: double
    //Cabecera, prototipo o signatura del método:
    // public static double calculo(int tipo, double pieza)
    public static double calculo(int tipo, double precio){
        double precioReal;
        precioReal = 0.0d;
        
        switch(tipo){
            case 1 -> precioReal=precio*0.92;
            case 2 -> precioReal=precio*0.9;
        }
        return precioReal;
    }
