...
public class Ppal_Supuesto14 {
    ...
    public static void main(String[] args) {        
        ...
        //Otra forma ->Es posible que os de errro
        System.out.println("\n-- LISTADO DEL ARRAY--");        
        for (Alquilable a: alquileres) {
            switch (a) {
                case Vivienda vivienda -> System.out.println("Vivienda :"+vivienda.getNumReferenciaCatastral());
                case Moto moto -> System.out.println("Moto :"+moto.getMatricula());
                case default -> System.out.println("Coche :"+((Coche) a).getMatricula());
            }                
        } 
