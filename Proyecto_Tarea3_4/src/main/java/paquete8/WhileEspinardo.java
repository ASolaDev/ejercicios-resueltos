...
public class WhileEspinardo {
    ...
    public static void main(String[] args) {
       ...
       permitirEntrar = (hora>7 && hora<12); //permitirEntrar tomará el valor de true o false
       
       while (permitirEntrar) //es equivalente a poner while(permitirEntrar==true) // while (hora>=8 && hora<12)
       {
