...
public class Nif {
    ...
    public Nif(int NIF) throws Exception {
        this.setNif(NIF);
    }

    public Nif(Nif n) throws Exception {
    ...
    public void setNif(String NIF) throws Exception {
        ...
        if (NIF.matches(expr)) {
            ...
            throw new Exception("DNI incorrecto, formato 12345678-Z");
        }               
    }

    public void setNif(int NIF) throws Exception {
        ...
        if (comprueba.length() <= 8) {
            ...
            throw new Exception("DNI incorrecto. Inserte al menos 8 dígitos");
        }
    }

    public void setNif(Nif n) throws Exception {
        this.setNif(n.nif);
    }
