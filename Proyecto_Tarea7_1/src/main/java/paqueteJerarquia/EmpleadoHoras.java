...
public class EmpleadoHoras extends Empleado{
    ...
    public EmpleadoHoras(int numHoras, Object object, String nombre, String apellidos, LocalDate fechaNac, LocalDate fechaTrabajo) throws Exception{
        ...
        if (numHoras <= 0){
            throw new Exception("Error, las horas han de ser positivas");
        }
        this.numHoras = numHoras;
    }
    public EmpleadoHoras(Object object, String nombre, String apellidos, LocalDate fechaNac, LocalDate fechaTrabajo) throws Exception {
        super(object, nombre, apellidos, fechaNac, fechaTrabajo);
        this.numHoras = 0;
    }
    ...
    public void setNumHoras(int numHoras) throws Exception{
        if (numHoras <= 0){
            throw new Exception("Error en el numero de horas, ha de ser positivas");
        }
        this.numHoras = numHoras;
    }
