...
public class Nif {
    ...
    public Nif(int NIF) throws NifException {
        this.setNif(NIF);
    }

    public Nif(Nif n) throws NifException {
    ...
    public void setNif(String NIF) throws NifException {
        ...
        if (NIF.matches(expr)) {
            ...
            if (letra != NIF.charAt(NIF.length()-1)) {
                throw new NifException("Letra incorrecta en "+NIF);
            }
            ...
            throw new NifException("DNI incorrecto, formato 12345678-Z");
        }               
    }

    public void setNif(int NIF) throws NifException {
        ...
        if (comprueba.length() <= 8) {
            ...
            throw new NifException("DNI incorrecto. Inserte al menos 8 dígitos");
        }
    }

    public void setNif(Nif n) throws NifException {
        this.setNif(n.nif);
    }
