 ...
 * @author isabel
 */
public class EmpleadoComisiones extends Empleado implements Incentivable, Comparable <EmpleadoComisiones> {
    ...
    @Override
    public int compareTo(EmpleadoComisiones c){
        return (int) (this.ventas - c.ventas);
    }
}
