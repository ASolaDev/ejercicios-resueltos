        ...
        do
        {
            ...
            switch(opcion)
            {
                case 1 -> {                    
                    ...
                    double perimetro=MiClase.perimetro_rectangulo(altura,base);
                ...
                case 2 -> {                      
                    ...
                    double f=MiClase.conversor_grados(c);
                ...
                case 4 -> {
                    ...
                    MiClase.ecuacion(a,b);
                }
                    
                case 5 -> {
                    double masa=Introducir.realDoble("Dime la masa en Kgr: ");                   
                    System.out.println(MiClase.energia(masa));
                }
                ...
                case 6 -> {
                    ...
                    switch (eleccion) 
                    {
                        case 'T' -> System.out.println(km+" km equivale a "+MiClase.millas_terrestres(km)+" millas terrestres");
                        case 'M' -> System.out.println(km+" km equivale a "+MiClase.millas_marinas(km)+" millas marinas");
                ...
                case 10 -> {                    
                    ...
                    System.out.println("La suma de las potencias entre "+x+" y "+y+" es "+MiClase.sumaCuadradosEntreX_Y(x,y));
                }
                ...
                case 13 -> { 
                    ...
                    MiClase.descendente(primero,segundo);
                }
                ...
                case 22 -> {
                    ...
                    System.out.println("El factorial del número "+azar+" es " +MiClase.factorial(azar));
                }
                ...
                case 23 -> {
                    ...
                    for(int n=1;n<=5;n++)
                    {
                        System.out.println("El factorial del número "+n+" es " +MiClase.factorial(n));
                    }
                }
                ...
                case 24 -> {
                    ...
                    int azar = (int) (Math.random() * 10 + 1);
                    MiClase.tabla_multiplicar(azar);
                }
                ...
                case 27 -> {
                    ...
                    int n = Introducir.entero("Dime un número entero: ");
                    System.out.println(n+ " tiene " +MiClase.contador_divisores(n)+" divisores");
                    System.out.println("La suma de sus divisores es  "+MiClase.suma_divisores(n));
                }
                ...
                case 28 -> {
                    ...
                    if((MiClase.suma_divisores(n) - n) == n) 
                ...
                case 31 -> {
                    ...
                    {
                        if(MiClase.primo(i)) //es lo mismo que decir MiClase.primo(i)==true
                        {
